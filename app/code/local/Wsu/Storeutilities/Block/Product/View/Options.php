<?php
class Wsu_Storeutilities_Block_Product_View_Options extends Mage_Catalog_Block_Product_View_Options {
//    protected $_product;
//
...
//    }
    ...
    public function getOptionHtml(Mage_Catalog_Model_Product_Option $option) {
        if($option->getType() == 'alteritemqty') {
            $renderer = $this->getOptionRender('alteritemqty');
		} else {
